...
contract Pausable is Ownable{
    ...
    function setPausedStatus(bool pauseStatus) public onlyOwner{
        require(_paused != pauseStatus, "Pause status is already in the same state");
        _paused = pauseStatus;
        if(_paused){
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(msg.sender == tokenOwner || isApprovedForAll(tokenOwner, msg.sender), "Caller must be owner or have approval");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == ownerOf(tokenId), "Address of the sender token must be owner");

        // TODO: require token is being transfered to valid address
        require(to != address(0), "Address of the receiver must be valid");
...
contract RealEstateTokenERC721Token is ERC721Metadata("RealEstateToken", "RET", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
